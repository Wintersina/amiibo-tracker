...
def generate_article_schema(title, description, url, date_published, author='Amiibo Tracker', publisher='Amiibo Tracker', image=None):
    """
...
def generate_product_schema(name, description, image, url, release_date=None, brand='Nintendo'):
    """
    Generate Product schema (JSON-LD) for amiibo detail pages.

    Args:
        name: Product name (amiibo name)
        description: Product description
        image: URL to product image
        url: Full URL to the product page
        release_date: Release date (optional)
        brand: Brand name (default: 'Nintendo')

    Returns:
        Dictionary representing Product schema
    """
    schema = {
        'name': name,
        'description': description,
...
def generate_organization_schema(name='Amiibo Tracker', url='https://amiibotracker.app', logo='https://amiibotracker.app/static/favicon.ico'):
    """
...
def generate_website_schema(name='Amiibo Tracker', url='https://amiibotracker.app', search_url='https://amiibotracker.app/amiibos/?search={search_term_string}'):
    """
